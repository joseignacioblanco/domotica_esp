...
//#define CHAT_ID "-1001611135015" //este id lo devuelve el bot IDBot de telegram. para el grupo de domotica tucuman
...
#define PUERTA_INGRESO_PIN 5 // gpio5 es el pin D1
